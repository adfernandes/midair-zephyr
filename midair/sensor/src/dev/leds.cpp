...
static const uint32_t multiplier = 32;
static const uint32_t period = (0xFF * multiplier); // microseconds
...
//   https://docs.zephyrproject.org/latest/reference/power_management/index.html?highlight=config_device_power_management#_CPPv422device_set_power_stateP6device5uint32_t12device_pm_cbPv
...
void set_red_led_state(uint8_t brightness) {
    ...
    const uint32_t pulse = (brightness * multiplier);
